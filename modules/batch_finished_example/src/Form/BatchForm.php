...
use Drupal\batch_finished_example\Batch\BatchClass;
...
class BatchForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['help'] = [
      '#markup' => $this->t('Submit this form to run a batch operation that will process 1000 items in batches of 100. Only one batch operation is given to the batch API, and this is called until a finished state is reached.'),
    ];
